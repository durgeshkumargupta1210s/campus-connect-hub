...
const Events = () => {
  ...
  const {
    events: hackathons,
    loading
  } = useEvents(); // Show all events, not just Hackathons
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => document.getElementById('upcoming-events')?.scrollIntoView({
      behavior: 'smooth'
    })
    ...
    className: "relative bg-white dark:bg-slate-900 border-border hover:shadow-xl transition-all group-hover:scale-105 h-full flex flex-col cursor-pointer overflow-hidden"
  }, hack.imageUrl && /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-4xl md:text-5xl font-bold text-foreground mb-4"
  }, "Event Timeline"), /*#__PURE__*/React.createElement("p", {
    className: "text-xl text-muted-foreground max-w-2xl mx-auto"
  ...
  }, "Follow these tips to ace your next event")), /*#__PURE__*/React.createElement("div", {
